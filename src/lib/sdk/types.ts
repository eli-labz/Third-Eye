/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║  THIRD EYE SDK — Core Type System                               ║
 * ║  Standardized Entity Model for Multi-Domain Intelligence        ║
 * ║                                                                 ║
 * ║  Built on THIRD EYE by Souleimen Mrad                              ║
 * ╚══════════════════════════════════════════════════════════════════╝
 */
...
export interface ThirdEyeEntity {
...
export interface ThirdEyeClientConfig {
  /** Base URL for THIRD EYE API endpoints */
  thirdeyeBaseUrl: string;
  /** Optional Lattice configuration */
  lattice?: LatticeConfig;
  /** Entity update callback */
  onEntityUpdate?: (entities: ThirdEyeEntity[]) => void;
  /** Connection status callback */
...
export interface StreamEvent {
  ...
  timestamp: string;
  payload: ThirdEyeEntity[] | SDKStatus | { id: string }[];
}
...
export interface IngestPayload {
  ...
  apiKey: string;
  /** Entities to ingest */
  entities: Partial<ThirdEyeEntity>[];
}
