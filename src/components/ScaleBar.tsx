  ...
  return (
    <div className="flex items-end gap-2 pointer-events-none">
      <div className="flex flex-col items-start">
        ...
        <svg width={scaleInfo.barWidth} height={7} role="presentation" aria-hidden="true" className="block">
          <line x1="0" y1="1" x2={scaleInfo.barWidth} y2="1" stroke="var(--gold-primary)" strokeWidth="2" strokeLinecap="round" />
          <line x1="0" y1="2" x2="0" y2="7" stroke="var(--gold-primary)" strokeWidth="1" />
          <line x1={scaleInfo.barWidth} y1="2" x2={scaleInfo.barWidth} y2="7" stroke="var(--gold-primary)" strokeWidth="1" />
        </svg>
      </div>
    </div>
  );
